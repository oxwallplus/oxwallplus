...
// add package pointers from plugins
OW::getPluginManager()->initPackagePointers();
...
if(OW::getRequest()->getParam('ow-light-cron') && !OW::getConfig()->getValue('base', 'cron_is_configured')) {
