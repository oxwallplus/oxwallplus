...
abstract class OW_Component extends OW_Renderable
{
    ...
    public function render() {
        if($this->getTemplate() === null) {
            ...
            if($plugin !== null) {
                $filename = OW::getAutoloader()->classToFilename(get_class($this), false) . '.html';
                if(!$template = OW::getThemeManager()->findTemplate($filename, $plugin, 'components')) {
                    $template = $plugin->getCmpViewDir() . $filename;
                }
