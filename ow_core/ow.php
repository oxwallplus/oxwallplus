...
final class OW
{
    ...
    public static function getDbo()
    {
        ...
        {
            if(!defined('OW_DB_HOST') || !defined('OW_DB_USER') || !defined('OW_DB_PASSWORD') || !defined('OW_DB_NAME')) {
                return false;
            }
            $params = array(
                'host' => OW_DB_HOST,
     ...
     *
     * @return OW_Translator
     */
    public static function getTranslator($plugin, $lang = null) {
        return OW_Translator::getInstance($plugin, $lang);
    }
    ...
    {
        return PERFORMANCE_BOL_DbCacheService::getInstance(); //TODO make configurable
    }
