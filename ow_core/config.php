...
class OW_Config
{
     ...
     * @return string|null
     */
    public function getValue($key, $name, $cache = true) {
        return $this->configService->findConfig($key, $name, $cache);
    }
    ...
    public function getValues($key) {
        return $this->configService->findConfigsList($key);
    }
    ...
    public function configExists($key, $name) {
        $value = $this->configService->findConfig($key, $name);
        if(is_string($value)) {
            return true;
        }
        return false;
