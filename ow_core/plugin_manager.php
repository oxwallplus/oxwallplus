...
class OW_PluginManager
{
    ...
    public function initPackagePointers() {
        ...
        foreach($plugins as $plugin) {
            ...
            $this->addPackagePointers($this->cachedObjects[$plugin->getKey()]->getDto());
        }
    }
