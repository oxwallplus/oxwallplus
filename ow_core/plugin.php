...
class OW_Plugin
{
    ...
    public function getDtoDir() {
        return $this->getRootDir() . "bol" . DS . 'dto' . DS;
    }

    public function getMobileDtoDir() {
        return $this->getMobileDir() . "bol" . DS . 'dto' . DS;
    }
    
    public function getDaoDir() {
        return $this->getRootDir() . "bol" . DS . 'dao' . DS;
    }

    public function getMobileDaoDir() {
        return $this->getMobileDir() . "bol" . DS . 'dao' . DS;
    }
    
    public function getFormDir() {
        return $this->getRootDir() . "forms" . DS;
    }

    public function getMobileFormDir() {
        return $this->getMobileDir() . "forms" . DS;
    }
    ...
    public function getStaticUrl() {
        return OW_URL_STATIC_PLUGINS . $this->getModuleName() . DS;
    }

    public function getStaticJsUrl() {
        return $this->getStaticUrl() . "js" . DS;
    }

    public function getStaticCssUrl() {
        return $this->getStaticUrl() . "css" . DS;
    }
