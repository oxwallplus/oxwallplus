 ...
 * @since 1.0
 */
abstract class OW_Validator extends FORM_Validator
{
...
class ExtensionValidator extends OW_Validator
{
    ...
    public function __construct($extensions = null) {
        ...
        if(empty($error)) {
            $errorMessage = 'Extension Validator Error!';
        }
 ...
 * @since 1.0
 */
class CaptchaValidator extends SECURITY_CLASS_SecurimageValidator
{
