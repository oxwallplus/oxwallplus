 ...
 * @since 1.7.2
 */
class BASE_CLASS_AvatarField extends FORM_Element
{
    /**
     * @param string $name
     */
    ...
    public function renderInput( $params = null )
    {
        ...
        $markup = '<div class="ow_avatar_field"><div class="custom-file">';
        $markup .= UTIL_HtmlTag::generateTag('input', $this->attributes).'
        <label class="custom-file-label" for="'.$this->getId().'">'.OW::getLanguage()->text('base', 'ajax_attachment_select_image_title').'</label>
        </div>';
