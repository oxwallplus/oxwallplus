...
class BOL_DocumentDao extends OW_BaseDao
{
    ...
    const CACHE_TAG_DOCUMENTS = 'base.document.find_all';
    ...
    public function findStaticDocument($uri) {
        ...
        return $this->findObjectByExample($example, self::CACHE_TIME, array(self::CACHE_TAG_DOCUMENTS));
    }
    ...
    public function findAllStaticDocuments()  {
        ...
        return $this->findListByExample($example, self::CACHE_TIME, array(self::CACHE_TAG_DOCUMENTS));
    }
