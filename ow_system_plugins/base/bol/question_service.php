        ...
        if ( empty($class) )
        {
            switch ( $presentation )
            {
                ...
                case self::QUESTION_PRESENTATION_PASSWORD :
                    $class = new ELEMENT_Password($fieldName);
                    break;
            }
        }
