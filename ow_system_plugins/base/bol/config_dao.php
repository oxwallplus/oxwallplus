...
class BOL_ConfigDao extends OW_BaseDao
{
    ...
    const CACHE_TAG_ALL_CONFIGS = 'configs.find.all';
    ...
    public function findConfigsList($key) {
        ...
        return $this->findListByExample($example, self::CACHE_TIME, array(self::CACHE_TAG_ALL_CONFIGS));
    }
    ...
    public function findAll($cacheLifeTime = 0, $tags = array()) {
        return parent::findAll(self::CACHE_TIME, array(self::CACHE_TAG_ALL_CONFIGS));
    }
    
    public function clearCache() {
        OW::getCacheManager()->clean(array(self::CACHE_TAG_ALL_CONFIGS));
    }
}