...
final class BOL_ConfigService
{
    ...
    public function findConfig($key, $name) {
        if(isset($this->cachedConfigs[$key][$name])) {
            return $this->cachedConfigs[$key][$name];
        }
    ...
    public function findConfigsList($key) {
        ...
        $this->generateCache();
        $configs = $this->configDao->findConfigsList($key);
        $result = array();
    ...
    public function addConfig($key, $name, $value, $description = null) {
        if($this->findConfigValue($key, $name)) {
    ...
    public function generateCache() {
        ...
        if($this->configDao->useCache()) {
            $configs = $this->configDao->findAll();
