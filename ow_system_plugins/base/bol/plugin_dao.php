...
class BOL_PluginDao extends OW_BaseDao
{
    ...
    const CACHE_TAG_ALL_PLUGINS = 'plugins.find.all';
    ...
    public function findAll($cacheLifeTime = 0, $tags = array()) {
        return parent::findAll(self::CACHE_TIME, array(self::CACHE_TAG_ALL_PLUGINS));
    }
    
    public function clearCache() {
        OW::getCacheManager()->clean(array(self::CACHE_TAG_ALL_PLUGINS));
    }
}
