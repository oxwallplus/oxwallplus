...
Oxwall Plus is an open source social network platform, which supports a variety of community driven websites, from narrow fan clubs and local communities to extended social networking portals. It was designed and developed with a creative approach pursuing one purpose - to allow people running communities as easy as possible.
Oxwall Plus is fork Oxwall, which was launched in 2010 and is supported by a nonprofit organization Oxwall Foundation (see http://www.oxwall.org/foundation/). For more information, visit Oxwall Plus website at http://www.oxwallplus.com

COPYRIGHT
=========

Oxwall Plus platform is licensed under Common Public Attribution License 1.0.
