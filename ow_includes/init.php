 ...
 */
if(file_exists(OW_DIR_ROOT . 'ow_includes' . DS . 'config.php')) {
    require_once OW_DIR_ROOT . 'ow_includes/config.php';
} else {
    require_once OW_DIR_ROOT . 'ow_includes/config.php.default';
}
...
$autoloader->addPackagePointer('VALIDATOR', OW_DIR_CORE . 'form' . DS . 'validators');
$autoloader->addPackagePointer('FORM', OW_DIR_CORE . 'form');
$autoloader->addPackagePointer('ELEMENT', OW_DIR_CORE . 'form' . DS . 'elements');
